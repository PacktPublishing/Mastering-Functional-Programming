...
# Haskell (https://github.com/freebroccolo/docker-haskell/blob/master/8.2/Dockerfile)
...
# Anaconda (https://hub.docker.com/r/continuumio/anaconda3/~/dockerfile/)
